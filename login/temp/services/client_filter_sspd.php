...
global $multirule, $datakey, $username, $user_rule, $engineer_id, $session, $host_get_sspd;
	...
	{
		$filter_ppat_id = " a.ppat_id='$eng_id' ";
	}
	...
	if ($status_sspd!="")
	{
		$filter_status_sspd = " a.status='$status_sspd' ";
	}
	else
	{
		$filter_status_sspd = "";
	...
	if ($tgl_sspd_from!="" && $tgl_sspd_to!="" )
	{
		$filter_tgl_sspd = " a.tgl_sspd BETWEEN '$tgl_sspd_from' AND '$tgl_sspd_to' ";
	}
	else
	{
		$filter_tgl_sspd = "";
	...
	if ($filter_status_sspd != "" && ($filter_data !=""))
	{
		$filter_data.=" AND ".$filter_status_sspd;
	}
	else
	{
		$filter_data.=$filter_status_sspd;
	}
	...
	if ($filter_tgl_sspd != "" && ($filter_data !=""))
	{
		$filter_data.=" AND ".$filter_tgl_sspd;
	}
	else
	{
		$filter_data.=$filter_tgl_sspd;
	}
