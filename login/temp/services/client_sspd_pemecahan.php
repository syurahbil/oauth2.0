...
global $multirule, $datakey, $username, $user_rule, $engineer_id, $session, $host_post_sspd_pemecahan;
...
$curl = new Curl($host_post_sspd_pemecahan);
$curl-> send('get', array(
			'code'=> $code,			 
...
function post($data) {
global $multirule, $datakey, $username, $user_rule, $session, $host_post_sspd_pemecahan, $host_get_pbb;
...
//require_once("../../dist/encrypt.php");	
global $multirule, $datakey, $username, $session, $host_post_sspd_pemecahan;
