...
global $multirule, $datakey, $username, $user_rule, $engineer_id, $session, $host_get_sspd;
	...
	if ($no_skpd_kb!="")
	{
		$filter_no_skpd_kb = " a.no_skpd_kb='$no_skpd_kb' ";
	}
	else
	{
		$filter_no_skpd_kb = "";
	...
	{
		$filter_tgl_skpd = " a.tgl_skpd_kb BETWEEN '$tgl_skpd_from' AND '$tgl_skpd_to' ";
	}
	else
	{
		$filter_tgl_skpd = "";
	...
	if ($filter_no_skpd_kb != "" && ($filter_data !=""))
	{
		$filter_data.=" AND ".$filter_no_skpd_kb;
	}
	else
	{
		$filter_data.=$filter_no_skpd_kb;
	}
